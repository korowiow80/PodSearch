...
<html>
  <head>
    ...
    <script type="text/javascript">function require() {}</script>

      <link href="http://me.com/my/not_found/en-us/2D38/stylesheet-packed.css" rel="stylesheet" type="text/css" />
...
<body onLoad="addBrowserNametoBody();" onorientationchange= "hideAddressBar();">
  ...
  <tr>
  	...
  	<tr>
  		<td height="50" colspan="3">
  		  ...
  		  document.write('<div class="copyRight"> &copy; Copyright '+year+' Apple Inc.</div>');
  		  </script>
    ...
    <!-- Include Site Javascript -->
      <script type="text/javascript" src="http://me.com/my/not_found/en-us/2D38/javascript-packed.js"></script>
